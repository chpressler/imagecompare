...
//      ImageCanvas canvas = new ImageCanvas(source);
	  	DisplayJAI canvas = new DisplayJAI(source);
    ...
    public static void main(String[] args) {
		new HelloWorld("http://www.chmoellmann.de/die_Bucher/Unbenannt145/baum.jpg");
	}
}