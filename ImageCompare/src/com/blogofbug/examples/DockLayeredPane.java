 ...
 * @author  nigel
 */
public class DockLayeredPane extends javax.swing.JFrame {
    LayeredDockPanel   layeredPane = null;
    /** Creates new form DockFinalDemo */
    public DockLayeredPane() {
        initComponents();
        layeredPane = new LayeredDockPanel(this);
        layeredPane.setVisible(true);
        this.getRootPane().getLayeredPane().add(layeredPane, LayeredDockPanel.DOCK_LAYER);
        this.getRootPane().getLayeredPane().add(new JLabel("HELLO"), new Integer(10));
        layeredPane.setBounds(0,0,400,400);
        //For the demo we add a copule of items
        layeredPane.addDockElement(new ImageLabel(new ImageIcon(DockFinalDemo.class.getResource("/com/blogofbug/examples/images/Acknowledgements.png")),32,32),"Thanks");
        layeredPane.addDockElement(new ImageLabel(new ImageIcon(DockFinalDemo.class.getResource("/com/blogofbug/examples/images/Cascade.png")),32,32),"Drips");
        layeredPane.addDockElement(new ImageLabel(new ImageIcon(DockFinalDemo.class.getResource("/com/blogofbug/examples/images/Dock.png")),32,32),"Docklets");
        layeredPane.addDockElement(new ImageLabel(new ImageIcon(DockFinalDemo.class.getResource("/com/blogofbug/examples/images/Quit.png")),32,32),"Bye Byes");
    ...
    private void normalSizeStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_normalSizeStateChanged
        layeredPane.setNormalSize(normalSize.getValue());
    ...
    private void dockedToItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_dockedToItemStateChanged
        layeredPane.setDockedTo(DockPanel.Side.valueOf(((String)dockedTo.getSelectedItem()).toUpperCase()));
