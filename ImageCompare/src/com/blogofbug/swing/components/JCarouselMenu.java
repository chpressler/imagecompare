...
import com.blogofbug.swing.components.effects.ImageRectangleEffect;
...
public class JCarouselMenu extends GradientPanel implements ListSelectionListener,MouseListener,KeyListener, ChangeListener, MouseWheelListener{
    ...
    public JCarouselMenu(ImageBorder border) {
        ...
        carousel.setLayout(new OffsetCaroselLayout(carousel,carousel.getComponentEffects()));
        ...
        menu = new JAnimatedList(new ImageRectangleEffect(
                    new Rectangle(0,0,0,0),
                    ImageUtilities.loadCompatibleImage(JCarouselMenu.class.getResource("/com/blogofbug/swing/borders/images/transparent_highlight.png").toString()),
                    new Insets(10,12,16,12)));
